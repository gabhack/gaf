...
ap.add_argument("-l", "--localfolder", type=str,
...
if __name__ == "__main__":
    ...
    file_list_local=[]
    file_glob_local = os.path.join(args["localfolder"], '*.pdf')
    file_list_local.extend(gfile.Glob(file_glob_local))
    ...
    for pdf in file_list_local:
        ...
        upload_blob(
            ...
            destination_blob_name=args["gcpfolder"]+"/"+filtered_file_name,
        )
        a=a+1
    print("Se subieron " + str(a) + " archivos")
