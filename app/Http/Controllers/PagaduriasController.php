...
public function getPagaduriasNamesAmi()
{
    $nombres = [
        ...
        "SEM CUCUTA", "SEM DOSQUEBRADAS", "SEM DUITAMA", "SEM EMBIGADO",
        "SEM EMVIGADO", "SEM ENVIGADO", "SEM FACATATIVA", "SEM FLORENCIA",
        "SEM FLORIDABLANCA", "SEM FUNZA", "SEM FUSAGASUGA", "SEM FUSAGAZUGA",
        "SEM GIRARDOT", "SEM GIRON", "SEM GUAINIA", "SEM IBAGUE",
        "SEM IPIALES", "SEM ITAGUI", "SEM JAMUNDI", "SEM LORICA",
        "SEM MAGANGUE", "SEM MAICAO", "SEM MALAMBO", "SEM MANIZALES",
        "SEM MEDELLIN", "SEM MONTERIA", "SEM MOSQUERA", "SEM NEIVA",
        "SEM PALMIRA", "SEM PASTO", "SEM PEREIRA", "SEM PIEDECUESTA",
        "SEM PITALITO", "SEM POPAYAN", "SEM QUIBDO", "SEM RIOHACHA",
        "SEM RIONEGRO", "SEM SABANETA", "SEM SAHAGUN", "SEM SAN",
        "SEM SANANDRES", "SEM SAN ANDRES", "SEM SANTA MARTA", "SEM SOACHA",
        "SEM SOGAMOSO", "SEM SOLEDAD", "SEM TULUA", "SEM TUMACO",
        "SEM TUNJA", "SEM TURBO", "SEM TUTLUA", "SEM URIBIA",
        "SEM VALLEDUPAR", "SEM VILLAVICENCIO", "SEM YOPAL", "SEM YUMBO",
        "SEM ZIPAQUIRA"
    ];
