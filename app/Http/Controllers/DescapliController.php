...
class DescapliController extends Controller
{
    ...
    public function consultaUnitaria(Request $request)
    {
        ...
        $consulta_cedula = Descapli::Where('doc', $doc)->get();
    ...
    public function resultadoAprobacion(Request $request)
    {
        $data_formulario = $request->data;
        $doc = $request->data['doc'];
        $info_datames = DatamesFopep::Where('doc', $doc)->first();
        $info_fechavinc = FechaVinc::Where('doc', $doc)->first();
        ...
        $data_visado = [
            ...
            'info_obligaciones' => json_encode($data_formulario['pagareSelected'])
        ];

        // Visado::create($data_visado);
        $id_consulta = Visado::create($data_visado)->id;
        $data_formulario['id_consulta'] = $id_consulta;
