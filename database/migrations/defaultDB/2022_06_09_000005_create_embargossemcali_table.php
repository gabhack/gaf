...
class CreateEmbargosSemCaliTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('pgsql')->create('embargossemcali', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
            $table->text('doc');
    ...
    {
        Schema::dropIfExists('embargossemcali');
    }
}
