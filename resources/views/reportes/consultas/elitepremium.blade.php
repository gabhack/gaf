		...
		<table class="table table-hover table-striped table-condensed table-bordered">
			...
			<tbody>
				@foreach($embargos as $embargo )
					<tr>
						<td>$embargo->tercero->entidad</td>
						<td>$embargo->valor</td>
						<td>$embargo->pagare</td>
						<td>$embargo->periodo</td>
						<td>$embargo->saldo</td>
					</tr>
				@endforeach
			</tbody>
		...
		<table class="table table-hover table-striped table-condensed table-bordered">
			<thead>
				<tr>
					...
					<th class="text-center">Cupo Libre Inversi&oacute;n</th>
				</tr>
			</thead>
			<tbody>
				@foreach($otrosIng as $otro )
					<tr>
						<td>$otro->pagaduria->pagaduria</td>
						<td>$otro->valor</td>
						<td>$otro->valor</td>
					</tr>
				@endforeach
