...
<nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow">
  ...
  <div>
    <dashboard-icon></dashboard-icon> Dashboard <span id="dynamic-breadcumb"></span>
  </div>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
      <a class="nav-link dropdown-toggle text-black-pearl" href="#" id="userDropdown" role="button"
