                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        <input class="form-control w-100 text-center" type="text" name="costo_certificados" id="costo_certificados" required value="0">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 text-center">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                <input class="form-control" type="text" name="AF2[cuota]" id="AF2_cuota" value="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
