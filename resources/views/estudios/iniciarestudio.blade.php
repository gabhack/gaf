                            ...
                            <div class="col-md-7">
                                <select name="desiciones" class="custom-select form-control" required>
                                    ...
                                    @foreach(decisiones_estudios() as $key => $decision)
                                        <option value="{{$key}}">{{$decision}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <label class="label-consulta" for="pad">Calificación/WAB:
                                    <select name="calif_wab" class="custom-select form-control" required>
                                        ...
                                        @foreach(calificaciones() as $key => $calificacion)
                                            <option value="{{$key}}">{{$calificacion}}</option>
                                        @endforeach
                                    </select>
                                </label>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        <input class="auto form-control w-100 text-center" data-a-sep="." data-a-dec="," data-a-sign="$ " type="text" name="costo_certificados" id="costo_certificados" required value="0">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 text-center">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-10" id="item-cuota-mensual">
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                <input class="auto form-control text-right" data-a-sep="." data-a-dec=","    data-a-sign="$ " type="text" name="AF1[cuota_mensual]" id="AF1_cuota_mensual" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                <select class="form-control" name="AF1[tasa]" id="AF1_tasa">
                                                    <option value="" >Seleccione uno...</option>
                                                    <option selected value="{{ number_format(1, 3) }}" >{{ number_format(1, 3) }}</option>
                                                    @for ($i = 1.1; $i <= 3; $i+=.1)
                                                        <option value="{{ number_format($i, 3) }}" >{{ number_format($i, 3) }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                <input class="form-control" type="text" name="AF1[plazo]" id="AF1_plazo" value="60">
                                            </div>
                                        </div>
                                    </div>
