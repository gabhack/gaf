    ...
    <form id="form_guardar" action="/estudios/guardar" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <label class="label-consulta" for="pad">Puntaje Datacredito:
                                    <input type="text" name="puntaje_datacredito" id="puntaje_datacredito" required>
                                </label>
                            </div>
                            <div class="col-md-4 text-center">
                                <label class="label-consulta" for="pad">Procesos en contra:
                                    <input type="text" name="proc_en_contra" id="proc_en_contra" placeholder="Opcional" min="1" max="99">
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            @php
                ...
                $total_servicio = $total_carteras*(int)$tasack/100;
