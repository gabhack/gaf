                ...
                <form action="{{ url('estudios') }}" method="get">
                    <div class="form-row" id="panel-pagaduria">
                        ...
                        <div class="form-group col-md-1">
                            <input type="text" class="form-control2 datepicker" name="filtro[fecha_desde]" id="fecha_desde"
                                placeholder="Desde"
                        ...
                        <div class="form-group col-md-1">
                            <input type="text" class="form-control2 datepicker" name="filtro[fecha_hasta]"
                        ...
                        <div class="form-group col-md-1">
                            <input type="number" class="form-control2 datepicker-periodo" name="filtro[periodo]"
                                id="periodo" placeholder="Periodo"
                                value="{{ isset($filtro['periodo']) ? $filtro['periodo'] : '' }}">
                        </div>
                        <div class="form-group col-md-2">
                            <input type="text" class="form-control2" name="busq" id="busq"
                    ...
                    @foreach ($lista as $estudio)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="row">
                                    <a class="btn btn-sm" style="color:green" href="{{ url('estudios/editarSinCIFIN', ['id' => $estudio->id]) }}" title="Modificar" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    <a class="btn btn-sm" style="color:green" href="{{ url('estudios/pagos', ['id' => $estudio->id]) }}" title="Pagos"><i class="fa fa-file" aria-hidden="true"></i></a>
