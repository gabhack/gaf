                ...
                <div class="col-md-7">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->idType == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>PAIS:</b>
                                ...
                                <div class="col-md-4">
                                    <label
                                        class="label-consulta{{ $dataCotizer->referenceAddress == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>DIRECCIÓN:</b>
                                        <p class="pad">NO ESTA</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->nombres == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>TIEMPO DE RESIDENCIA:</b>
                                        <p class="pad">NO ESTA</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label
                                        class="label-consulta{{ $dataCotizer->referenceBarrio == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>BARRIO:</b>
                                        <p class="pad">NO ESTA</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->city == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>CIUDAD:</b>
                                        <p class="pad">{{ $dataCotizer->city }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->estrato == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>ESTRATO:</b>
                                        <p class="pad">{{ $dataCotizer->estrato }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->gender == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>DIRECCIÓN LABORAL:</b>
                                        <p class="pad">{{ $dataCotizer->addressWork }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->gender == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>SEDE/LUGAR DE TRABAJO:</b>
                                        <p class="pad">{{ $dataCotizer->workCity }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label
                                        class="label-consulta{{ $dataCotizer->phoneNumber == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>TELÉFONO PERSONAL:</b>
                                        <p class="pad">{{ $dataCotizer->phoneNumber }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label
                                        class="label-consulta{{ $dataCotizer->phoneWork == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>TELÉFONO LABORAL:</b>
                                        <p class="pad">{{ $dataCotizer->phoneWork }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->celular == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>CELULAR:</b>
                                        <p class="pad">{{ $dataCotizer->phoneNumber }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->email == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>CORREO ELECTRONICO:</b>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->birthday == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>FECHA DE NACIMIENTO:</b>
                                ...
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->gender == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>TIPO DE VIVIENDA:</b>
                                        <p class="pad">NO ESTA</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->gender == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>NIVEL EDUCATIVO:</b>
                                        <p class="pad">{{ $dataCotizer->studies }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->childs == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>PERSONAS A CARGO:</b>
                                        <p class="pad">{{ $dataCotizer->living }} </p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->gender == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>CANTIDAD DE HIJOS:</b>
                                        <p class="pad">{{ $dataCotizer->childs }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label class="label-consulta{{ $dataCotizer->gender == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>ESTADO CIVIL:</b>
                                        <p class="pad">{{ $dataCotizer->maritalStatus }}</p>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                    <label
                                        class="label-consulta{{ $dataCotizer->idExpeditionDate == '' ? ' label-warning' : '' }}"
                                        for="pad"><b>FECHA EXPEDICION CC:</b>
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad"><b>Score AMI:</b>
                                        <input class="form-control" type="number" name="puntaje_datacredito"
                                            id="puntaje_datacredito" value="" placeholder="Opcional" disabled>
                                    </label>
                                </div>
                                <div class="col-md-4 text-center">
                                ...
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad"><b>Score TRANSUNION:</b>
                                        <input class="form-control" type="number" name="puntaje_sifin"
                                            id="puntaje_sifin" value="582" placeholder="Opcional" disabled>
                                    </label>
                                </div>
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad">Cuentas de Ahorros:
                                        <input class="form-control text-left" type="text" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Activa" value="Activa" min="1"
                                            max="99" disabled>
                                        <input class="form-control text-left" type="text" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Inactiva" value="Inactiva" min="1"
                                            max="99" disabled>
                                        <input class="form-control text-left" type="text" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Embargada" value="Embargada" min="1"
                                            max="99" disabled>
                                    </label>
                                </div>
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad">Cantidad de cuentas:
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="3" min="1"
                                            max="99" disabled>
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="5" min="1"
                                            max="99" disabled>
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="2" min="1"
                                            max="99" disabled>
                                    </label>
                                </div>
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad">Cantidad de cuentas:
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="9" min="1"
                                            max="99" disabled>
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="0" min="1"
                                            max="99" disabled>
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="2" min="1"
                                            max="99" disabled>
                                ...
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad">Cantidad de cuentas:
                                        ...
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            ...
                                            max="99" disabled>
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="1" min="1"
                                            max="99" disabled>
                                    </label>
                                </div>
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad">Cantidad de cuentas:
                                        ...
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            ...
                                            max="99" disabled>
                                        <input class="form-control" type="number" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="8" min="1"
                                            max="99" disabled>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad"><b>Score AMI:</b>
                                        <input class="form-control" type="number" name="puntaje_datacredito"
                                            id="puntaje_datacredito" value="123" placeholder="Opcional" disabled>
                                    </label>
                                </div>
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad"><b>Score EXPERIAN:</b>
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad">Estados:
                                        <input class="form-control text-left" type="text" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Activa" value="Activo" min="1"
                                            max="99" disabled>
                                        <input class="form-control text-left" type="text" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Inactiva" value="Cerrado" min="1"
                                            max="99" disabled>
                                    </label>
                                </div>
                                <div class="col-md-4 text-center">
                                    <label class="label-consulta col-12" for="pad">Cantidad de procesos:
                                        <input class="form-control" type="text" name="proc_en_contra"
                                            id="proc_en_contra" placeholder="Opcional" value="Proceso judicial"
                        ...
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <label class="label-consulta" for="pad"><b>AÑO:</b>
                                    <div class="row">
                                        <select class="form-control col-md-12" name="costo_servicio_tr_ptg"
                                            id="costo_servicio_tr_ptg">
                                ...
                                <label class="label-consulta" for="pad"><b>MES:</b>
                                    <div class="row">
                                        <div class="form-group col-md-5">
                                            <select class="form-control" name="costo_servicio_tr_ptg"
                                                id="costo_servicio_tr_ptg">
                        ...
                        <div class="panel-body">
                            <div id="accordion" role="tablist">
                                @foreach ($obligaciones as $estado => $obligacionesEstado)
                                    @php
                                        // Reemplazar 'alDia' por 'Obligaciones al día' y 'enMora' por 'Obligaciones en mora'
                                        $estadoTitulo = $estado === 'alDia' ? 'Obligaciones al día' : 'Obligaciones en mora';
                                    @endphp
                                    <h4>{{ $estadoTitulo }}</h4> <!-- Mostrar el estado (alDia o enMora) como título -->
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                                        ...
                                        @foreach ($embargos[0] as $key => $res)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a
                                                        href="/estudios/detalle-cartera/{{ $dataCotizer->id }}-{{ $res['id'] }}/2">Detalle</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
                                        ...
                                        @foreach ($carteras as $key => $res)
                                            <tr>
                                                ...
                                                <td id="td-compra-{{ $res->id }}">
                                                    @if ($res->estatus == 0)
                                                        <button type="button"
                                                            onclick="comprarCartera({{ $res->id }})">Comprar</button>
                                                    @else
                                                        <span>Comprada</span>
                                                    @endif
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#modalCartera">Agregar cartera</button><br><br>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td valign="top">
                                        ...
                                        <table border="0" cellspacing="1" cellpadding="2" class="tab1"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center"><input type="radio" name="opcion_credito"
                                                            value="CLI" onchange="recalcular()" disabled=""></td>
                                                    <td style="font-size:16"><b>CUPO DE LIBRE INVERSION</b></td>
                                                    <td><input type="text" id="opcion_cuota_cli"
                                                            name="opcion_cuota_cli" value="" size="15"
                                                            style="height:30; text-align:right; font-size:16; font-weight:bold; "
                                                            readonly=""></td>
                                                    <td colspan="2"><input type="text" id="opcion_desembolso_cli"
                                                            name="opcion_desembolso_cli" value=""
                                                            style="width:95%; height:30; text-align:right; font-size:16; font-weight:bold; "
                                                            readonly=""></td>
                                                </tr>
                                                <tr>
                                                    <td align="center"><input type="radio" name="opcion_credito"
                                                            value="CCC" onchange="recalcular()" checked=""></td>
                                                    <td style="font-size:16"><b>CUPO CON COMPRAS</b></td>
                                                    <td><input type="text" id="opcion_cuota_ccc"
                                                            name="opcion_cuota_ccc" value="" size="15"
                                                            style="height:30; text-align:right; font-size:16; font-weight:bold; "
                                                            readonly=""></td>
                                                    <td colspan="2"><input type="text" id="opcion_desembolso_ccc"
                                                            name="opcion_desembolso_ccc" value=""
                                                            style="width:95%; height:30; text-align:right; font-size:16; font-weight:bold; "
                                                            readonly=""></td>
                                                </tr>
                                                <tr>
                                                    <td align="center"><input type="radio" name="opcion_credito"
                                                            value="CMP" onchange="recalcular()"></td>
                                                    <td style="font-size:16"><b>CUPO MAXIMO POSIBLE</b></td>
                                                    <td><input type="text" id="opcion_cuota_cmp"
                                                            name="opcion_cuota_cmp" value="" size="15"
                                                            style="height:30; text-align:right; font-size:16; font-weight:bold; "
                                                            readonly=""></td>
                                                    <td colspan="2"><input type="text" id="opcion_desembolso_cmp"
                                                            name="opcion_desembolso_cmp" value=""
                                                            style="width:95%; height:30; text-align:right; font-size:16; font-weight:bold; "
                                                            readonly=""></td>
                                                </tr>
                                                <tr>
                                                    <td align="center"><input type="radio" name="opcion_credito"
                                                            value="CSO" onchange="recalcular()"></td>
                                                    <td style="font-size:16"><b>CUPO SOLICITADO</b></td>
                                                    <td><input type="text" id="opcion_cuota_cso"
                                                            name="opcion_cuota_cso" value="" size="15"
                                                            onfocus="this.value = this.value.replace(/\,/g, '')"
                                                            onblur="if(isnumber(this.value)==false) { this.value='0'; return false; } else { if (this.value == '') { this.value = '0'; } if (parseFloat(this.value) > document.formato.opcion_cuota_ccc.value.replace(/\,/g, '')) { this.value = document.formato.opcion_cuota_ccc.value.replace(/\,/g, ''); alert('El valor de la cuota no debe ser mayor a $' + document.formato.opcion_cuota_ccc.value); } recalcular(); separador_miles(this); }"
                                                            style="height:30; text-align:right; font-size:16; font-weight:bold; color:#CC0000;  ">
                                                    </td>
                                                    <td colspan="2"><input type="text" id="opcion_desembolso_cso"
                                                            name="opcion_desembolso_cso" value=""
                                                            style="width:95%; height:30; text-align:right; font-size:16; font-weight:bold; "
                                                            readonly=""></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">FECHA INCORP. PAGADURÍA</td>
                                                    <td><input type="text" name="fecha_incorp_pagaduria"
                                                            value=""
                                                            onchange="if (this.value != '') { if(validarfecha(this.value)==false) {this.value=''; return false} }"
                                                            style="height:30; text-align:right; font-size:16; font-weight:bold; color:#CC0000; width: 100px">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><input type="text"
                                                                id="total_carteras_comprar" name="total_carteras_comprar"
                                                                value=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <select id="descuento5" name="descuento5"
                                                                onchange="document.formato.lb_porcentaje_costos.value = tipos_cliente[this.value];recalcular();"
                                                                style=" color:#FFFFFF;" readonly="">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" id="lb_porcentaje_costos"
                                                                name="lb_porcentaje_costos" value="" size="14"
                                                                style="text-align:center; "
                                                                onchange="if(isnumber_punto(this.value)==false) {this.value=''; return false} else { if (this.value == '') { this.value = ''; } recalcular(); }">
                                                        </td>
                                                        <td colspan="2"><input type="text" id="descuento5_valor"
                                                                name="descuento5_valor" value=""
                                                                style="width:95%; text-align:right; color:#FFFFFF;"
                                                                readonly=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">IVA</td>
                                                        <td><input type="text" id="descuento6" name="descuento6"
                                                                value="19" size="14"
                                                                style="text-align:center; color:#FFFFFF;" readonly="">
                                                        </td>
                                                        <td colspan="2"><input type="text" id="descuento6_valor"
                                                                name="descuento6_valor" value=""
                                                                style="width:95%; text-align:right; color:#FFFFFF;"
                                                                readonly=""></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td colspan="2"><input type="text"
                                                                name="descuento_transferencia_valor" value=""
                                                                style="width:95%; text-align:right; color:#FFFFFF;"
                                                                readonly=""></td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table border="0" cellspacing="1" cellpadding="2" width="100%">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="descuento1" value="3.93"
                                                                size="14" style="text-align:center; color:#FFFFFF;">
                                                        </td>
                                                        <td colspan="2"><input type="text" name="descuento1_valor"
                                                                value=""
                                                                style="width:95%; text-align:right; color:#FFFFFF;"
                                                                readonly=""></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="descuento2" value=""
                                                                onchange="if(isnumber_punto(this.value)==false) {this.value='35'; return false} else { if (this.value == '') { this.value = '35'; } recalcular(); }"
                                                                size="14" style="text-align:center; "></td>
                                                        <td colspan="2"><input type="text"
                                                                name="descuento2_valor" value=""
                                                                style="width:95%; text-align:right; color:#FFFFFF;"
                                                                readonly=""></td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <table border="0" cellspacing="1" cellpadding="2" width="95%">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td colspan="3"><input type="text" name="valor_credito"
                                                                value="" style="width:100%; text-align:right;"
                                                                readonly=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" style="font-size:18" width="170">
                                                            <b>DESEMBOLSO CLIENTE</b>
                                                        </td>
                                                        <td colspan="3"><input type="text"
                                                                id="desembolso_cliente" name="desembolso_cliente"
                                                                value=""
                                                                style="width:100%; height:45; text-align:right; font-size:18; font-weight:bold; "
                                                                readonly=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3"><input type="text" id="decision"
                                                                name="decision" value=""
                                                                style="width:100%; height:45; text-align:center; font-size:18; font-weight:bold; "
                                                                readonly=""><input type="hidden" id="decisionh"
                                                                name="decisionh" value=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">NO. LIBRANZA</td>
                                                        <td colspan="3"><input type="text" name="nro_libranza"
                                                                value="" style="width:100%; text-align:center; ">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">VALOR VISADO</td>
                                                        <td colspan="3"><input type="text" name="valor_visado"
                                                                value=""
                                                                onfocus="this.value = this.value.replace(/\,/g, '')"
                                                                onblur="if(isnumber(this.value)==false) {this.value='0'; return false} else { separador_miles(this); }"
                                                                style="width:100%; text-align:right; "></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">FECHA CONFIRMACIÓN</td>
                                                        <td colspan="3"><input type="text"
                                                                name="fecha_llamada_clientef" value=""
                                                                size="10"
                                                                onchange="if(validarfecha(this.value)==false) {this.value=''; return false}"
                                                                style=";">&nbsp;HORA<input type="text"
                                                                name="fecha_llamada_clienteh" value=""
                                                                size="5"
                                                                onchange="if(validarhora(this.value)==false) {this.value=''; return false}"
                                                                style=";"><select name="fecha_llamada_clientej"
                                                                style=";">
                                                                <option value=""></option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <select id="id_subestado" name="id_subestado"
                                                                style="">
                                                                <option value=""></option>
                                                            </select>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <select name="porcentaje_extraprima" style=";"
                                                                onchange="if (this.value != '0' &amp;&amp; PorcentajeSeguroExtraPrima('', document.formato.plazo.value, this.value) == '0') { alert('No hay condiciones de Extra Prima para el plazo establecido'); this.value = document.formato.porcentaje_extraprimah.value; } else { recalcular(); }">
                                                                <option value="0"></option>
                                                            </select>
                                                            <input type="hidden" name="porcentaje_extraprimah"
                                                                value="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3"><input
                                                                onfocus="this.value = this.value.replace(/\,/g, '')"
                                                                onblur="if (isnumber(this.value) == false) { this.value = '0'; return false } else { if (this.value == '') { this.value = '0'; } separador_miles(this); }"
                                                                type="text" name="monto_aprob_aliado"
                                                                value="0" style="width:100%; text-align:right;">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="70">
                                                            <select id="tasa_interes" class="form-control"
                                                                name="tasa_interes" onchange="recalcular()">
                                ...
                                <div id="panel-AF1" class="col-md text-center hidden">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                <div class="col-md-5 text-right">
                                                    <label class="label-consulta" for="pad">Carteras a
                                                        comprar</label>
                                                </div>
                                                <div class="col-md">
                                                    <input class="form-control text-right" type="text"
                                                        name="carteras_a_comprar_af1" id="carteras_a_comprar_af1"
                                                        value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control text-right font-weight-bold"
                                                        type="text" name="AF1_cupo_max" id="AF1_cupo_max"
                                                        value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10" id="item-cuota-mensual">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="auto form-control text-right" data-a-sep="."
                                                        data-a-dec="," data-a-sign="$ " type="text"
                                                        name="AF1[cuota_mensual]" id="AF1_cuota_mensual"
                                                        value="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control" type="text" name="AF1[plazo]"
                                                        id="AF1_plazo" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10" id="item-saldo-ref">
                                            <div class="row">
                                                <div class="col-md-5 text-right">
                                                    <label class="label-consulta" for="pad">Saldo de
                                                        Refinanciación</label>
                                                </div>
                                                <div class="col-md">
                                                    <input class="form-control" type="text"
                                                        name="AF1[saldo_refinanciacion]" id="AF1_saldo_refinanciacion"
                                                        value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                <div class="col-md-5 text-right">
                                                    <label class="label-consulta" for="pad">Intereses anticipados
                                                        (%)</label>
                                                </div>
                                                <div class="col-md-3">
                                                    <input class="form-control" type="text"
                                                        name="AF1[intereses_anticipados]" id="AF1_intereses_anticipados"
                                                        value="2000">
                                                </div>
                                                <div class="col-md">
                                                    <input class="form-control text-right" type="text"
                                                        name="AF1[intereses_anticipados_valor]"
                                                        id="AF1_intereses_anticipados_valor" value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                <div class="col-md-5 text-right">
                                                    <label class="label-consulta" for="pad">Gastos Administrativos
                                                        (%)</label>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control text-right" type="text"
                                                        name="AF1[costos_valor]" id="AF1_costos_valor" value=""
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control text-right" type="text"
                                                        name="AF1_seguro" id="AF1_seguro" value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control text-right" type="text"
                                                        name="AF1_GMF" id="AF1_GMF" value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control text-right" type="text"
                                                        name="AF1_iva" id="AF1_iva" value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <input class="form-control text-center font-weight-bold"
                                                        type="text" name="AF1_valor_credito" id="AF1_valor_credito"
                                                        value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 text-center" id="item-desembolso-cliente">
                                                    <label class="label-consulta" for="pad">Desembolso al
                                                        Cliente</label>
                                                </div>
                                                <div class="col-md-12">
                                                    <input class="form-control text-center font-weight-bold"
                                                        type="text" name="AF1_cuota" id="AF1_cuota"
                                                        value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control" type="text"
                                                        name="carteras_a_comprar_af2" id="carteras_a_comprar_af2"
                                                        value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                <div class="col-md text-right">
                                                    <label class="label-consulta" for="pad">Factor x millón <span
                                                            class="hidden"
                                                            id="label-saneamiento">(saneamiento)</span></label>
                                                </div>
                                                <div class="col-md">
                                                    <input class="form-control" type="text"
                                                        name="AF2[factor_x_millon]" id="AF2_factor_x_millon"
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control" type="text" name="AF2[plazo]"
                                                        id="AF2_plazo" value="120">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="form-control" type="text" name="AF2_cupo_max"
                                                        id="AF2_cupo_max" value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <input class="auto form-control" data-a-sep="." data-a-dec=","
                                                        data-a-sign="$ " type="text" name="AF2[cuota]"
                                                        id="AF2_cuota" value="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <input class="form-control text-center font-weight-bold"
                                                        type="text" name="AF2_monto_prestar" id="AF2_monto_prestar"
                                                        value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <input class="form-control text-center font-weight-bold"
                                                        type="text" name="AF2_monto_max" id="AF2_monto_max"
                                                        value="" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md">
                                            <div class="row">
                                                <div class="col-md-12 text-center">
                                                    <label class="label-consulta" for="pad">Saldo al
                                                        cliente</label>
                                                </div>
                                                <div class="col-md-12">
                                                    <input class="form-control text-center font-weight-bold"
                                                        type="text" name="AF2_saldo" id="AF2_saldo"
                                                        value="" disabled>
                                                </div>
                                            </div>
                                        </div>
    ...
    <form action="{{ route('estudio.actualizar') }}" method="post">
        ...
        <div align="center">
            ...
            <button type="submit" class="btn btn-primary" style="width: 300px;"
                class="form-control">Aceptar</button>
        </div>
    </form>


    <!-- Modal -->
    <div class="modal fade bd-example-modal-xl" id="modalCartera" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                <form action="{{ route('estudios.cartera') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" value="{{ $dataCotizer->estudio ? $dataCotizer->estudio->id : null }}"
                            name="estudios_id">
