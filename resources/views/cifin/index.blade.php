                            ...
                            <form action="{{ url('cifin/consultarAdmin') }}" method="post" class="form-group col-md-12">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input required="required" name="cedula" type="number"
                                               class="form-control text-center">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <b class="panel-label">APELLIDO PATERNO:</b>
                                        <input required="required" name="apellido" type="text"
                                               class="form-control text-center" onkeyup="mayus(this);">
                                    </div>
                                </div>
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="{{ url('cifin') }}">Cifin</a></li>
@endsection
