...
@section('content')
    ...
    <div class="container-fluid row">
            ...
            <div class="box-rounded bg-gainsboro text-black-pearl text-left">
                ...
                <ul>
                    ...
                    <div class="d-flex justify-content-end">
                        <a v-b-toggle.collapse-1 class="text-right" style="cursor: pointer; color: #10dd8e;">Ver más <i
        ...
        <div class="col-12 col-lg-6 pt-5">
            <div class="box-rounded bg-gainsboro text-black-pearl text-left">
                ...
                <ul>
                    ...
                    <div class="d-flex justify-content-end">
                        <a v-b-toggle.collapse-3 class="text-right" style="cursor: pointer; color: #10dd8e;">Ver más <i
                                class="fas fa-angle-right"></i></a>
                    </div>
                </ul>
            </div>
        ...
        <div class="col-12 col-lg-6 pt-5">
            <div class="box-rounded bg-gainsboro text-black-pearl text-left">
                ...
                <ul>
                    ...
                    <div class="d-flex justify-content-end">
                        <a v-b-toggle.collapse-4 class="text-right" style="cursor: pointer; color: #10dd8e;">Ver más <i
                                class="fas fa-angle-right"></i></a>
                    </div>
                </ul>
            </div>
        ...
        <div class="col-12 col-lg-6 pt-5">
            <div class="box-rounded bg-gainsboro text-black-pearl text-left">
                <p class="box-label text-left"><span>LOCALIZACIÓN DE USUARIOS Y CARGA MASIVA DE PENSIONADOS</span></p>
                <ul>
                    <li>
                        <a href="{{ url('colpensiones') }}" style="color: black;">Colpensiones</a>
                    </li>
                    <li>
                        <a href="{{ url('fiduprevisora') }}" style="color: black;">Fiduprevisora</a>
                    </li>
                    <li>
                        <a href="{{ url('joinpensiones') }}" style="color: black;">Localizar cedulas (subidas en
                            archivo)</a>
                    </li>
                    <b-collapse id="collapse-5"></b-collapse>
                    <div class="d-flex justify-content-end">
                        <a v-b-toggle.collapse-5 class="text-right" style="cursor: pointer; color: #10dd8e;">Ver más <i
                                class="fas fa-angle-right"></i></a>
                    </div>
                </ul>
            </div>
