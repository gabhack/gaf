        ...
        <div class="col-12 col-lg-6 pt-5">
            <div class="box-rounded bg-gainsboro text-black-pearl text-left">
              ...
              <a href="" style="color: black;"></a>
                    ...
                    <div class="d-flex justify-content-end"><a v-b-toggle.collapse-1 class="text-right"
        ...
        <div class="col-12 col-lg-6 pt-5">
            <div class="box-rounded bg-gainsboro text-black-pearl text-left">
              ...
              <a href="{{ url('historyClient' )}}" style="color: black;"></a>
                    ...
                    <div class="d-flex justify-content-end"><a v-b-toggle.collapse-2 class="text-right"
                            style="cursor: pointer; color: #10dd8e;">Ver más <i class="fas fa-angle-right"></i></a></div>
                </ul>
            </div>
        </div>
      ...
      <ul>
        ...
        <li>
          <a href="{{ url('certificados' )}}" style="color: black;">Certificados de Nacimiento - Defunción</a>
                    ...
                    <div class="d-flex justify-content-end"><a v-b-toggle.collapse-4 class="text-right"
                            style="cursor: pointer; color: #10dd8e;">Ver más <i class="fas fa-angle-right"></i></a></div>
                </ul>
            </div>
        </div>
