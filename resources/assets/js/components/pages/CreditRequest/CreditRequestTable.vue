      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          <tr v-for="credit in credits" :key="credit.id">
            ...
            <td>
              <div v-if="credit.documents && credit.documents.length">
  ...
  export default {
    ...
    data () {
      return {
        allPagaduriasMap: {
          ...
          132:'SED VAUPES',32:'SED VICHADA',27:'SED SINCELEJO',34:'SEM ARMENIA',
          ...
          129:'SEM RIONEGRO',108:'SEM SABANETA',142:'SEM SAHAGÚN',158:'SEM SAN ANDRÉS',
    ...
    methods: {
      formatCurrency (v) {
        ...
        return isNaN(n) ? '$0' : new Intl.NumberFormat('es-CO', {
          style: 'currency',
          currency: 'COP',
