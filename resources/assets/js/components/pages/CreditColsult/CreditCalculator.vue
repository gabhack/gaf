    ...
    <form id="credit-form" @submit.prevent="submitData" :class="collapsed ? 'collapsed' : null">
        <b-row style="width: 100%; padding: 5rem">
            <b-col cols="12" md="6" class="pr-0">
                <b-card
                    no-body
                    class="card-main mt-5 mb-5 ml-5"
                    style="
                            ...
                            <b-col cols="12">
                                <b-form-group>
                                    ...
                                    <b-input-group class="dues">
                                        <b-form-select id="gender" v-model="form.due" :options="selectDues" required />
                                    </b-input-group>
                                </b-form-group>
                            </b-col>
                        </b-form-row>
                        ...
                        <b-form-row>
                            <b-col cols="6">
                                <b-form-group label-for="gender" class="form-group">
                                    <b-form-select id="gender" v-model="form.gender" :options="gender" required />
                                </b-form-group>
                            </b-col>
                            <b-col cols="6">
                ...
                <div id="credit-detail">
                    <b-list-group>
                        ...
                        <b-list-group-item>
                            <b-row>
                                <b-col cols="7">
                                    <span class="h5 font-weight-bold"> Cuota </span>
                                </b-col>
                                <b-col cols="5">
...
export default {
    ...
    watch: {
        ...
        'form.client': function (newVal) {
            if (
                (newVal === 'pensionado' && this.form.age > 75) ||
                (newVal === 'docente-sector-publico' && this.form.gender === 'Femenino' && this.form.age > 57) ||
                (newVal === 'docente-sector-publico' && this.form.gender === 'Masculino' && this.form.age > 62)
            ) {
        ...
        'form.age': function (newVal) {
            if (newVal) {
                ...
                if (
                    (this.form.client === 'pensionado' && newVal > 75) ||
                    (this.form.client === 'docente-sector-publico' && this.form.gender === 'Femenino' && newVal > 57) ||
                    (this.form.client === 'docente-sector-publico' && this.form.gender === 'Masculino' && newVal > 62)
                ) {
                    this.showButton = false;
                    this.$swal({
                        icon: 'warning',
    ...
    methods: {
        simulator() {
            ...
            this.cuota =
                (this.totalCredit2 * ((Math.pow(1 + tasa / 100, this.dues) * tasa) / 100)) /
                (Math.pow(1 + tasa / 100, this.dues) - 1);
        },
        generateDues(count) {
