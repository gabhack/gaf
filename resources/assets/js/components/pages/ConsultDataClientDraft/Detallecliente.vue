      ...
      <div class="panel-body">
        <div class="row">
                            <div class="col-md-4 text-center">
                              <label class="label-consulta col-12 mb-2" for="pad"><b>OBLIGACIONES:</b>
                                <input class="form-control text-left" type="text" name="proc_en_contra" id="proc_en_contra" placeholder="Obligaciones vigentes al dia" value="OBLIGACIONES VIGENTES AL DIA" min="1" max="99" disabled>                                                               
                                  <input class="form-control text-left" type="text" name="proc_en_contra" id="proc_en_contra" placeholder="Obligaciones vigentes en mora" value="OBLIGACIONES VIGENTES EN MORA" min="1" max="99" disabled>                                                               
                                  <input class="form-control text-left" type="text" name="proc_en_contra" id="proc_en_contra" placeholder="EMBARGOS" value="EMBARGOS" min="1" max="99" disabled>                             
                              </label>
                            </div>
                            <div class="col-md-4 text-center">
                                <label class="label-consulta col-12 mb-2" for="pad"><b>CANTIDAD OBLIGACIONES:</b>
                            ...
                            <div class="col-md-4 text-center">
                              <div class="row">
                                ...
                                <div class="col-6">
                                  <label class="label-consulta" for="pad"><b>VALOR</b>
                                    <input class="form-control" type="number" name="proc_en_contra" id="proc_en_contra" placeholder="Opcional" value="3" min="1" max="99" disabled>
                                    <input class="form-control" type="number" name="proc_en_contra" id="proc_en_contra" placeholder="Opcional" value="6" min="1" max="99" disabled>
                                  </label>
                                </div>
                              </div>
                            </div>
