    ...
    <div class="panel panel-primary mb-3">
      ...
      <div class="panel-body">
        ...
        <div class="row">
          ...
          <div class="col-12 tables-space mb-4" v-if="pagadurias.datamesseceduc && pagaduriaType != 'SEDVALLE'">
            ...
            <button
              type="button"
              class="btn btn-primary"
              v-on:click="modalConfirmConsultPag('showDatamesseceduc', 'SEDVALLE')"
            >
              Ver más
            </button>
          ...
          <template v-if="showDatamesseceduc">
            ...
            <DescapliEmpty />
            <EmbargosSeceduc :embargossedvalle="embargossedvalle" />
          </template>
          ...
          <div class="col-12 tables-space mb-4" v-if="pagadurias.datamessemcali && pagaduriaType != 'SEMCALI'">
            ...
            <button type="button" class="btn btn-secondary" v-on:click="showDatamessemcali = false">Cerrar</button>
          </div>

          <template v-if="showDatamessemcali">
            <DatamesSemCali :datamessemcali="pagadurias.datamessemcali" :user="user" />
            <EmploymentHistory :user="user" :fechavinc="fechavinc" :datamesseceduc="pagadurias.datamessemcali" />
            <Descapli :descapli="descapli" />
            <Descnoap :descnoap="descnoap" />
          </template>
        </div>
