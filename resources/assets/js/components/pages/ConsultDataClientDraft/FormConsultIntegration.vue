<template>
    <div class="panel mb-3 col-md-12">
        <div class="panel-heading">
            <b>PGADURÍAS PARA ESTE DOCUMENTO</b>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <b-form-select v-else v-model="dataclient.pagaduria" class="text-center">
                        <option :value="null" disabled>Listado de pagadurías consultadas</option>
                    </b-form-select>
                </div>

                <!-- Se eliminó el botón CONSULTAR PAGADURIAS -->
            </div>
        </div>
    </div>
</template>
