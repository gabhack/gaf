                    ...
                    <template v-if="arrayCoupons && arrayCoupons.length > 0">
                        ...
                        <b-row>
                            <b-col cols="12" class="d-flex justify-content-center align-items-center">
                                ...
                                <b>{{
                                    (couponsIngresos && couponsIngresos.amount ? couponsIngresos.amount : 0) | currency
                                }}</b>
                            </b-col>
                        </b-row>
                    </template>
                    <p v-else-if="coupons && coupons.length === 0">
                        El cliente no cuenta con obligaciones vigentes al día.
                    </p>
