<template>
          ...
          <div class="mt-3 table-responsive">
            <table role="table" aria-colcount="5" class="table b-table table-striped table-hover">
              <thead role="rowgroup" class="table-header-nowrap">
                <tr role="row">
                  <th class="text-center" role="columnheader" scope="col" aria-colindex="1">Nombre y Apellido</th>
                  <th class="text-center" role="columnheader" scope="col" aria-colindex="2">Tipo de Documento</th>
                  <th class="text-center" role="columnheader" scope="col" aria-colindex="3">N<sup>a</sup> Documento</th>
                  <th class="text-center" role="columnheader" scope="col" aria-colindex="4">Fecha de Nacimiento</th>
                  <th class="text-center" role="columnheader" scope="col" aria-colindex="5">Edad</th>
                  <th class="text-center" role="columnheader" scope="col" aria-colindex="1">Teléfono / Celular</th>
                </tr>
              </thead>
              <tbody role="rowgroup">
                <tr role="row">
                  <td aria-colindex="1" role="cell">{{ datamesSed.nombre_usuario || '--' }}</td>
                  <td class="text-center" aria-colindex="2" role="cell">Cédula de Ciudadanía</td>
                  <td class="text-center" aria-colindex="3" role="cell">{{ datamesSed.doc || '--' }}</td>
                  <td class="text-center" aria-colindex="4" role="cell">{{ fechaNacUi || '--' }}</td>
                  <td class="text-center" aria-colindex="5" role="cell">{{ edadUi || '--' }}</td>
            ...
            <table role="table" aria-colcount="7" class="table b-table table-striped table-hover">
              <thead role="rowgroup" class="table-header-nowrap">
                <tr role="row">
                  ...
                  <th class="text-center" role="columnheader" scope="col" aria-colindex="3">Ciudad / Municipio</th>
                  ...
                  <th class="text-center" role="columnheader" scope="col" aria-colindex="7">Nivel Educativo</th>
                </tr>
              </thead>
              <tbody role="rowgroup">
                <tr role="row">
                  <td class="text-center" aria-colindex="2" role="cell">{{ datamesSed.direccion_residencial || '--' }}</td>
                  <td class="text-center" aria-colindex="3" role="cell">{{ datamesSed.ciudad || '--' }}</td>
                  <td class="text-center" aria-colindex="4" role="cell">{{ datamesSed.correo_electronico || '--' }}</td>
                  <td class="text-center" aria-colindex="5" role="cell">{{ datamesSed.pagaduria || '--' }}</td>
                  <td class="text-center" aria-colindex="6" role="cell">{{ datamesSed.profesion || '--' }}</td>
                  <td class="text-center" aria-colindex="7" role="cell">{{ datamesSed.niveleducac || '--' }}</td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  export default {
    ...
    computed: {
      ...
      datamesSedArray () { return this.datamesSed ? [this.datamesSed] : [] },
      fechaNacUi () {
        const v = this.datamesSed?.fecha_nacimiento
      ...
      edadUi () {
        ...
        const mOff = hoy.getMonth() - nac.getMonth()
        if (mOff < 0 || (mOff === 0 && hoy.getDate() < nac.getDate())) e--
        return e
      }
    }
  }
