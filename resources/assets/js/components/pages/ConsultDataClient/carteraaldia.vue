        ...
        <div class="row">
            <div class="col-12">
                <template v-if="id_consult === null">
                    <h4 class="title text-start pt-3">Cartera al Día</h4>
                    ...
                    <div class="table-responsive">
                        <div>
                            <b-table striped hover :items="HistoryConsult" :fields="fields" :busy="isBusy"></b-table>
                            <!-- <template #cell(actions)="data">
                                <button
                                    type="button"
                                    class="btn btn-primary mb-2"
...
export default {
    ...
    methods: {
        ...
        getHistoryConsults() {
            this.isBusy = true;
            const url = `/get-coupons`;

            // Datos de ejemplo
            const datosEjemplo = {
            doc: "30734351",
            pagaduria: "SEM YUMBO",
            pagaduriaLabel: "pagaduria1"
            };
