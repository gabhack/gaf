    ...
    <div class="container-fluid">
        ...
        <div v-if="type_consult === 'individual'">
            ...
            <div id="consulta-container" class="row">
                ...
                <div class="col-12" v-if="consultaDescapli.length > 0">
                    <div class="panel">
                        <div class="panel-heading">
                            <b>Resultado</b>
                        </div>
                ...
                <div class="col-md-12" v-if="plan === 'premium'  || enableFirstStep === true">
                ...
                <div class="col-md-12" v-if="plan === 'premium'  || enableSecondStep === true">
                    <div class="panel panel-primary">
                ...
                <div class="col-md-12" v-if="plan === 'premium'  || enableThirdStep === true">
                    <div class="panel panel-primary">
