                ...
                <div class="panel mb-3 col-md-12">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <b-modal ref="modal" hide-footer title="Carga Individual">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 d-flex align-items-center">
                                            <b-button class="mt-3" variant="outline-warning" block @click="hideModal"
                                                >Cargar</b-button
                                            >
                                        </div>
                                    </div>
                                ...
                                <b-modal ref="modal2" hide-footer title="Carga Individual">
                                    ...
                                    <div class="row">
                                        <div class="col-6 d-flex align-items-center">
                                            <b-button class="mt-3" variant="outline-danger" block @click="hideModal2"
                                                >Cerrar</b-button
                                            >
                                        </div>
                                        <div class="col-6 d-flex align-items-center">
                                            <b-button class="mt-3" variant="outline-warning" block @click="hideModal2"
                                                >Cargar</b-button
                                            >
                                        </div>
                                    </div>
                            ...
                            <div class="col-6"></div>
                            <div id="table1" style="display: none">HOLA</div>

                            <div id="table2" style="display: none">ADIÓS</div>
                        </div>
                    </div>
                    <div class="panel-heading" style="box-shadow: 10px 5px 5px #09ac80">
