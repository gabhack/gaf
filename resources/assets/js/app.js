...
import PendingDemographicUploadForm from './components/pages/Demographic/PendingDemographicUploadForm.vue'
import PendingDemographicUploadList from './components/pages/Demographic/PendingDemographicUploadList.vue'
...
Vue.component('pending-demographic-upload-form', PendingDemographicUploadForm)
Vue.component('pending-demographic-upload-list', PendingDemographicUploadList)
...
/* páginas varias */
Vue.component('integration', Index)
...
Vue.component('client-data-component-draft-without-visa', require('./components/pages/ConsultDataClientDraft/indexCompanyWithoutVisa.vue').default)
...
Vue.component('form-consult-integration', require('./components/pages/ConsultDataClientDraft/FormConsultIntegration.vue').default)
Vue.component('consulta-pagadurias-form-consult', require('./components/pages/ConsultDataClientDraft/ConsultaPagaduriasFormConsult.vue').default)
Vue.component('client-data-component-draft-integration', require('./components/pages/ConsultDataClientDraft/indexIntegration.vue').default)
...
Vue.component('credit-requests-list', require('./components/pages/ConsultDataClientDraft/indexCreditRequest.vue').default)

Vue.component('data-coverage', require('./components/pages/Admin/DataCoverage.vue').default)
